...
// 💰 USER COINS
// ===============================
let userCoins = 100; // demo value, replace with server-side user coins if available

function deductCoins(amount){
  if(userCoins >= amount){
    userCoins -= amount;
    alert(`✅ ${amount} coins deducted. Remaining coins: ${userCoins}`);
    return true;
  } else {
